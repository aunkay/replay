...
| Portfolio trading | Trade base and comparisons using shared cash, buying power, positions and portfolio P&L | Shared portfolio engine implemented with capital/short/fee/volume tests; UI, replay/Live/session integration and E2E pending |
